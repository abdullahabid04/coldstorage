...
<main class="main" id="top">
        ...
        <nav class="navbar navbar-expand-lg container-small px-3 px-lg-7 px-xxl-3">
            <a class="navbar-brand flex-1 flex-lg-grow-0" href="{{ url('/') }}">
                <div class="d-flex align-items-center"><img src="{{ asset('assets/img/icons/logo.png') }}"
                                                            alt="{{ config('app.name', 'Sentron') }}" width="27"/>
                    <p class="logo-text ms-2">{{ config('app.name', 'Sentron') }}</p>
                </div>
            </a>
            <div class="d-lg-none">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item border-bottom border-translucent border-bottom-lg-0"><a
                            class="nav-link lh-1 py-0 fs-9 fw-bold py-3" aria-current="page" href="#">Home</a></li>
                    <li class="nav-item border-bottom border-translucent border-bottom-lg-0"><a
                ...
                <div class="d-grid d-lg-flex align-items-center">
                    ...
                    @auth
                        <a class="btn btn-phoenix-primary order-0" href="{{ url('/home') }}">
                            <span class="fw-bold">Dashboard</span>
                        </a>
                    @else
                        <a class="btn btn-link text-body order-1 order-lg-0 ps-4 me-lg-2" href="{{ route('login') }}">Sign
                            in</a>
            ...
            <div class="container-small px-lg-7 px-xxl-3">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6 pt-8 pb-6 position-relative z-5 text-center text-lg-start">
                        <h1 class="fs-3 fs-md-2 fs-xl-1 fw-black mb-4">
                            <span class="text-gradient-info me-3">Realtime</span>Monitor,<br/>Anywhere Anytime</h1>
                        <p class="mb-5 pe-xl-10">
                            Sentron-EMS is a cloud-based system offering real-time temperature and humidity monitoring,
                            essential for industries requiring environmental control, with remote access through a
                            user-friendly mobile app. Sign up to get started.
                        </p>
                        <a class="btn btn-lg btn-primary rounded-pill me-3" href="#!" role="button">Sign up</a>
                        <a class="btn btn-link me-2 fs-8 p-0" href="#!" role="button">
                            Check Demo
        ...
        <div class="container-small px-lg-7 px-xxl-3">
            <div class="row g-0">
                <div class="col-6 col-md-3">
                    <div
                        class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end border-translucent">
                        <img class="img-fluid" src="../../assets/img/brand2/netflix-n.png" alt=""/></div>
                </div>
                <div class="col-6 col-md-3">
                    <div
                        class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end-md border-translucent">
                        <img class="img-fluid" src="../../assets/img/brand2/blender.png" alt=""/></div>
                </div>
                <div class="col-6 col-md-3">
                    <div
                        class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end border-end-md border-translucent">
                        <img class="img-fluid" src="../../assets/img/brand2/upwork.png" alt=""/></div>
                </div>
                <div class="col-6 col-md-3">
                    <div
                        class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end-lg-0 border-translucent">
                        <img class="img-fluid" src="../../assets/img/brand2/facebook-f.png" alt=""/></div>
                </div>
                <div class="col-6 col-md-3">
                    <div
                        class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end border-bottom border-bottom-md-0 border-translucent">
                        <img class="img-fluid" src="../../assets/img/brand2/pocket.png" alt=""/></div>
                </div>
                <div class="col-6 col-md-3">
                    <div
                        class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end-md border-bottom border-bottom-md-0 border-translucent">
                ...
                <div class="col-6 col-md-3">
                    <div
                        ...
                        <img class="img-fluid" src="../../assets/img/brand2/discord.png" alt=""/></div>
                </div>
                <div class="col-6 col-md-3">
                    <div
                        class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end-lg-0 border-translucent">
                        <img class="img-fluid" src="../../assets/img/brand2/google-g.png" alt=""/></div>
                </div>
            </div>
    ...
    <section class="pt-13 pb-10" id="feature">
        <div class="container-small px-lg-7 px-xxl-3">
            <div class="text-center mb-10 mb-md-5">
                ...
                <p class="mb-0">Focus only on functionalities for your digital products with PowerEye! Leave the UIs for
                    us.</p>
        ...
        <div class="container-small px-lg-7 px-xxl-3">
            ...
            <div class="carousel testimonial-carousel slide position-relative dark__bg-gray-1100"
                ...
                <div class="bg-holder d-none d-xl-block"
                     style="background-image:url(../../assets/img/bg/39.png);background-size:186px;background-position:top 20px right 20px;"></div>
                <!--/.bg-holder-->
                ...
                <div class="carousel-inner">
                    <div class="carousel-item text-center py-8 px-5 px-xl-15 active"><span
                        ...
                        <h3 class="fw-semibold fst-italic mt-3 mb-8 w-xl-70 mx-auto lh-base">Amazing theme, excellent
                    ...
                    <div class="carousel-item text-center py-8 px-5 px-xl-15 false"><span
                        ...
                        <h3 class="fw-semibold fst-italic mt-3 mb-8 w-xl-70 mx-auto lh-base">An excellent theme with
                            fast support team to aid the development process! Thanks team PowerEye!</h3>
                        <div class="d-flex align-items-center justify-content-center gap-3 mx-auto">
                            <div class="avatar avatar-3xl ">
                                <img class="rounded-circle border border-2 border-primary"
                    ...
                    <div class="carousel-item text-center py-8 px-5 px-xl-15 false"><span
                        ...
                        <h3 class="fw-semibold fst-italic mt-3 mb-8 w-xl-70 mx-auto lh-base">Amazing support system with
                            quickest reply and steady communication of the concerned.</h3>
                        <div class="d-flex align-items-center justify-content-center gap-3 mx-auto">
                            <div class="avatar avatar-3xl ">
                                <img class="rounded-circle border border-2 border-primary"
        ...
        <div class="container-small px-lg-7 px-xxl-3">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <p class="mb-10">Keep it simple with PowerEye and help your organization grow with the abundance you
                        look for.</p>
                    <div class="row gy-6">
    ...
    <section class="counter-container">
        ...
        <div class="bg-holder d-none d-lg-block"
             style="background-image:url(../../assets/img/bg/bg-left-25.png);background-size:auto;background-position:left center;"></div>
        <!--/.bg-holder-->
        <div class="bg-holder d-none d-lg-block"
             style="background-image:url(../../assets/img/bg/bg-right-25.png);background-size:auto;background-position:right center;"></div>
        <!--/.bg-holder-->
        <div class="container-small position-relative">
            <div class="row gx-0 gy-8 justify-content-center">
                <div
                    ...
                    <h1 class="fs-3 fs-lg-1 fw-bolder text-info mb-3"><span>$</span><span
                ...
                <div
                    ...
                    <h1 class="fs-3 fs-lg-1 fw-bolder text-info mb-3"><span
                    ...
                    <div class="pricing-card">
                        <div class="card bg-transparent border-0">
                            <div class="card-body p-7">
                                ...
                                <h1 class="fs-3 d-flex align-items-center gap-1 mb-3">$15<span class="fs-8 fw-normal">/ month</span>
                                </h1>
                    ...
                    <div class="pricing-card">
                        <div class="card bg-transparent border border-2 border-info rounded-4">
                            <div class="card-body p-7">
                                ...
                                <h1 class="fs-3 d-flex align-items-center gap-1 mb-3">$23<span class="fs-8 fw-normal">/ month</span>
                                </h1>
                                ...
                                <ul class="fa-ul ps-4 m-0 pricing">
                                    ...
                                    <li class="d-flex align-items-center mb-3"><span class="fa-li"><span
                                        ...
                                        <p class="mb-0">Custom fields</p><span
                                            class="badge badge-phoenix badge-phoenix-info ms-2 fs-10">Info</span>
                                    </li>
                                    <li class="d-flex align-items-center mb-3"><span class="fa-li"><span></span></span>
                                        <p class="mb-0">Task dependencies</p>
                                    </li>
                    ...
                    <div class="pricing-card">
                        <div class="card bg-transparent border-0">
                            <div class="card-body p-7">
                                ...
                                <h1 class="fs-3 d-flex align-items-center gap-1 mb-3">$40<span class="fs-8 fw-normal">/ month</span>
                                </h1>
                                <button class="btn btn-lg w-100 mb-7 btn-outline-primary">Buy</button>
                                <h5 class="mb-4">What’s included</h5>
                                <ul class="fa-ul ps-4 m-0 pricing">
            ...
            <div class="card rounded-4 border-0 offer-card">
                <div class="card-body d-md-flex align-items-center gap-4 py-5"><img class="mb-4 mb-md-0 d-dark-none"
                    ...
                    <div>
                        ...
                        <p class="mb-6">PowerEye customers may have access to additional features for a limited
                            promotional period</p><a class="btn btn-link me-2 p-0 fs-9" href="#!" role="button">Contact
                ...
                <div class="col-lg-4">
                    <div class="blog-card"><img class="w-100 rounded-3" src="../../assets/img/blog/blog-5.png" alt=""/>
                        <div class="d-flex align-items-cente mt-3"><a
                                class="btn-link text-decoration-none text-body-secondary d-flex align-items-center me-3"
                                href="#!"><span class="fa-solid fa-eye fs-9"></span><span
                                    class="fs-10 ms-1 lh-1">2563</span></a><a
                                class="btn-link text-decoration-none text-body-secondary d-flex align-items-center me-3"
                                href="#!"><span class="fa-solid fa-heart fs-9"></span><span
                                    class="ms-1 fs-10 lh-1">125</span></a><a
                                class="btn-link text-decoration-none text-body-secondary d-flex align-items-center"
                                href="#!"><span class="fa-solid fa-comment fs-9"></span><span class="ms-1 fs-10 lh-1">125</span></a>
                        </div>
                        <span class="badge text-bg-primary mb-2 mt-4">SEO</span>
                        <h4 class="mb-3 pe-sm-5 lh-lg">Top 10 ways to Ace SEO for your business</h4><a
                            class="btn-link px-0 d-flex align-items-center fs-9 fw-bold" href="#!" role="button">See
                ...
                <div class="col-lg-4">
                    <div class="blog-card"><img class="w-100 rounded-3" src="../../assets/img/blog/blog-6.png" alt=""/>
                        <div class="d-flex align-items-cente mt-3"><a
                                class="btn-link text-decoration-none text-body-secondary d-flex align-items-center me-3"
                                href="#!"><span class="fa-solid fa-eye fs-9"></span><span
                                    class="fs-10 ms-1 lh-1">1256</span></a><a
                                class="btn-link text-decoration-none text-body-secondary d-flex align-items-center me-3"
                                href="#!"><span class="fa-solid fa-heart fs-9"></span><span
                                    class="ms-1 fs-10 lh-1">325</span></a><a
                                class="btn-link text-decoration-none text-body-secondary d-flex align-items-center"
                                href="#!"><span class="fa-solid fa-comment fs-9"></span><span
                                    class="ms-1 fs-10 lh-1">32</span></a></div>
                        <span class="badge text-bg-primary mb-2 mt-4">Marketing</span>
                ...
                <div class="col-lg-4">
                    <div class="blog-card"><img class="w-100 rounded-3" src="../../assets/img/blog/blog-7.png" alt=""/>
                        <div class="d-flex align-items-cente mt-3"><a
                                class="btn-link text-decoration-none text-body-secondary d-flex align-items-center me-3"
                                href="#!"><span class="fa-solid fa-eye fs-9"></span><span
                                    class="fs-10 ms-1 lh-1">142</span></a><a
                                class="btn-link text-decoration-none text-body-secondary d-flex align-items-center me-3"
                                href="#!"><span class="fa-solid fa-heart fs-9"></span><span
                                    class="ms-1 fs-10 lh-1">123</span></a><a
                                class="btn-link text-decoration-none text-body-secondary d-flex align-items-center"
                                href="#!"><span class="fa-solid fa-comment fs-9"></span><span
                                    class="ms-1 fs-10 lh-1">22</span></a></div>
                        <span class="badge text-bg-primary mb-2 mt-4">Marketing</span>
        ...
        <div class="container-small px-lg-7 px-xxl-3">
            ...
            <div class="row g-5 g-lg-5">
                <div class="col-md-6 mb-5 mb-md-0 text-center text-md-start">
                    ...
                    <p class="mb-5">Stay connected with PowerEye's Help Center; PowerEye is available for your
                        necessities at all times.</p>
                    <div class="d-flex flex-column align-items-center align-items-md-start gap-3 gap-md-0">
                        <div class="d-md-flex align-items-center">
                            <div class="icon-wrapper shadow-info"><span class="uil uil-phone text-primary fs-4 z-1 ms-2"
                        ...
                        <div class="d-md-flex align-items-center">
                            <div class="icon-wrapper shadow-info"><span
                                    class="uil uil-envelope text-primary fs-4 z-1 ms-2" data-bs-theme="light"></span>
                            </div>
                            <div class="flex-1 ms-3"><a class="fw-semibold text-body" href="mailto:powereye@email.com">powereye@email.com</a>
                            </div>
                        </div>
                        <div class="mb-6 d-md-flex align-items-center">
                            <div class="icon-wrapper shadow-info"><span
                                    class="uil uil-map-marker text-primary fs-4 z-1 ms-2" data-bs-theme="light"></span>
                            </div>
                            <div class="flex-1 ms-3"><a class="fw-semibold text-body" href="#!">39163 Amir Drive Suite
                                    802</a></div>
                        </div>
                        <div class="d-flex"><a href="#!"><span
                                    class="fa-brands fa-facebook fs-6 text-primary me-3"></span></a><a href="#!"><span
                                    class="fa-brands fa-twitter fs-6 text-primary me-3"></span></a><a href="#!"><span
    ...
    <section class="alternate-landing-team" id="team">
        <div class="position-absolute w-100 h-100 start-0 end-0 top-0 bg-body dark__bg-gray-1000"
             style="transform: skewY(-6deg); transform-origin: right"></div>
        <div class="bg-holder d-none d-xl-block"
             style="background-image:url(../../assets/img/bg/bg-left-23.png);background-size:auto;background-position:left center;"></div>
        <!--/.bg-holder-->
        <div class="bg-holder d-none d-xl-block"
             style="background-image:url(../../assets/img/bg/bg-right-23.png);background-size:auto;background-position:right center;"></div>
        <!--/.bg-holder-->
    ...
    <section class="bg-body dark__bg-gray-1000 pb-10 overflow-hidden">
        <div class="container-small px-lg-7 px-xxl-3">
            ...
            <div class="bg-holder"
                 style="background-image:url(../../assets/img/bg/bg-left-24.png);background-size:auto;background-position:left center;"></div>
            <!--/.bg-holder-->
            <div class="bg-holder"
                 style="background-image:url(../../assets/img/bg/bg-right-24.png);background-size:auto;background-position:right center;"></div>
            <!--/.bg-holder-->
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="card py-md-9 px-md-13 border-0 z-1 shadow-lg">
                        <div class="bg-holder"
                             style="background-image:url(../../assets/img/bg/bg-38.png);background-position:center;background-size:100%;"></div>
                        <!--/.bg-holder-->
                        <div class="card-body position-relative"><img class="img-fluid mb-5 d-dark-none"
                                ...
                                width="260" alt="..."/>
                            <p class="fw-bold">2008 Premium Icons <span class="text-primary fs-6">.</span> Included FREE
                                with it</p>
                            <h1 class="fs-6 fs-sm-4 fs-lg-2 fw-bolder lh-sm mb-3">Join<span
                                    class="gradient-text-primary mx-2">PowerEye</span><span>Today</span></h1>
        ...
        <div class="container-small px-lg-7 px-xxl-3">
            <div class="row gx-xxl-8 gy-5 align-items-center mb-5">
                <div class="col-xl-auto text-center"><a href="#"><img
                            src="{{ asset('assets/img/icons/logo-white.png') }}" height="48" alt=""/></a></div>
                ...
                <div class="col-xl-auto">
                    <div class="d-flex align-items-center justify-content-center gap-8"><a class="text-white" href="#!">
                            <span class="fa-brands fa-facebook"></span></a><a class="text-white" href="#!"> <span
                                class="fa-brands fa-twitter"></span></a><a class="text-white" href="#!"> <span
