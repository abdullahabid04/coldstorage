...
@section('content')
    ...
    <div class="mb-5">
        <h2 class="text-bold text-body-emphasis">Companies</h2>
        <p class="text-body-tertiary lead">
            Manage Company creation process.
        </p>
    </div>

    <div id="companies"
         data-list='{"valueNames":["name"],"page":10,"pagination":true}'>
        ...
        <div class="mx-n4 mx-lg-n6 px-4 px-lg-6 mb-9 bg-body-emphasis border-y mt-2 position-relative top-1">
            <div class="table-responsive scrollbar ms-n1 ps-1">
                <table class="table table-sm fs-9 mb-0">
                    <thead>
                    <tr>
                        <th class="sort align-middle" scope="col" data-sort="name" style="width:15%; min-width:200px;">
                            COMPANY NAME
                        </th>
                    ...
                    @foreach($companies as $row)
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="align-middle ps-3">
                                <a class="d-flex align-items-center text-body text-hover-1000 ps-0"
                            ...
                            <td class="last_active align-middle text-end white-space-nowrap text-body-tertiary">
                                <div class="btn-reveal-trigger position-static">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end py-2" style="">
                                        <a class="dropdown-item" href="{{ route('companies.edit', $row->id) }}">
                                            Edit
                                        </a>
