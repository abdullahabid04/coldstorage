...
@section('content')
    ...
    <div class="mb-5">
        ...
        <p class="text-body-tertiary lead">
            Manage devices for areas in stores.
        </p>
    </div>
            ...
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative">
                        <input class="form-control search-input search" type="search" placeholder="Search devices"
                               aria-label="Search"/>
                            ...
                            <td class="actions align-middle text-end white-space-nowrap text-body-tertiary">
                                <div class="btn-reveal-trigger position-static">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a class="dropdown-item" href="{{ route('devices.edit', $row) }}">
                                            Edit
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <form action="{{ route('devices.destroy', $row) }}" method="POST"
