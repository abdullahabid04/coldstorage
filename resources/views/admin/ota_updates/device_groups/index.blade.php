...
@section('content')
    ...
    <div class="mb-5">
        <h2 class="text-bold text-body-emphasis">Device Groups</h2>
        ...
        <div class="row align-items-center justify-content-between g-3 mb-4">
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative">
                        <input class="form-control search-input search" type="search" placeholder="Search device groups"
                               aria-label="Search"/>
            ...
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    <a class="btn btn-primary" href="{{ route('device_groups.create') }}">
            ...
            <div class="table-responsive scrollbar ms-n1 ps-1">
                <table class="table table-sm fs-9 mb-0">
                    ...
                    <tr>
                        ...
                        <th class="align-middle" scope="col" data-sort="device_count" style="width:20%; min-width:200px;">
                            Devices Count
                        </th>
                    ...
                    @foreach($groups as $group)
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="id align-middle white-space-nowrap">
                                <h6 class="mb-0 fw-semibold">{{ $group->id }}</h6>
                            </td>
                            ...
                            <td class="actions align-middle text-end white-space-nowrap text-body-tertiary">
                                <div class="btn-reveal-trigger position-static">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a class="dropdown-item" href="{{ route('device_groups.edit', $row) }}">
                                            Edit
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <form action="{{ route('device_groups.destroy', $row) }}" method="POST"
